...
<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;">
    ...
    <div class="header" region="north" height="50" showSplit="false" showHeader="false">
        <h1 style="margin: 0; margin-top: 10px; margin-left: 10px; color: #FFF; cursor: default; font-family: 微软雅黑, 黑体, 宋体;">
            视频联网报警平台V2.0</h1>
    ...
    <!-- Header部分结束 -->
    <!-- 版权部分开始 -->
    <div title="south" region="south" style="background-color: #3A83C3" ; showSplit="false" showHeader="false"
         height="30">
    ...
    <div title="center" region="center" style="border: 0;" bodyStyle="overflow:hidden;">
        <div id="HdDiv1" style="display: black; border: 1px; width: 100%; height: 100%">
            <div class="mini-splitter" style="width: 100%; height: 100%;"
                 borderStyle="border-style: solid;border-top-width:0;border-right-width:0">
                <div size="220" maxSize="250" minSize="100" showCollapseButton="true">
                    <div id="leftTree" borderStyle="border-style: solid;border-width:1px 0 0 0;"
                         class="mini-outlooktree" url="<%=rootpath%>/outlooktree.txt" onnodeclick="onItemSelect"
                ...
                <div showCollapseButton="false" style="border: 0">
                    <div class="mini-splitter" vertical="true" style="width: 100%; height: 100%;"
                        ...
                        <div size="85.5%" showCollapseButton="false" style="border: 0">
                            <iframe id="mainframe" frameborder="0" name="main" style="width: 100%; height: 100%;"
                                    border="0"></iframe>
                        </div>
